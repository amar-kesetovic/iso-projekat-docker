...
### Razlike u CloudFormation i Terraform pristupu

CloudFormation je nativan alat koji se koristi samo za AWS dok s druge strane Terraform može generisati infrastrukturu na mnogim cloud provajderima.
CloudFormation koristi JSON ili YAML, s druge strane Terraform koristi HCL koji je mnogo čitljiviji.
CloudFormation radi automatski rollback ukoliko u pola kreiranja dogodi neki problem, s druge strane to nije slučaj za Terraform i servisi ostanu u neispravnom i nekonsizstentnom stanju, mi vodimo računa o stanju.
